...
const galleryItems = ref([
  {
    foto: new URL('@desktop/img/gems/IMG_6667.jpg', import.meta.url).href,
    title: "GEMISTRY GEMS",
    naam: "Ines",
  ...
  {
    foto: new URL('@desktop/img/closeup/kaolo.JPG', import.meta.url).href,
    title: "CLOSE-UP VIEW",
    naam: "Chelsey",
  ...
  {
    foto: new URL('@desktop/img/random_image/IMG_4072.jpg', import.meta.url).href,
    title: "EVENTS",
    naam: "Club Nyx",
...
#main_image {
  ...
  align-items: center;
  background-image: url("@desktop/img/main/image1.jpeg");
